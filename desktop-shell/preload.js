...
contextBridge.exposeInMainWorld('desktopBridge', {
  ...
  pickImagePaths: () => ipcRenderer.invoke('desktop:pick-image-paths'),
  readImageFile: (request) => ipcRenderer.invoke('desktop:read-image-file', request),
  ...
  loadProjectManifest: (request) => ipcRenderer.invoke('desktop:load-project-manifest', request),
  loadProjectImage: (request) => ipcRenderer.invoke('desktop:load-project-image', request),
  saveProjectImage: (request) => ipcRenderer.invoke('desktop:save-project-image', request),
  saveProjectManifest: (request) => ipcRenderer.invoke('desktop:save-project-manifest', request),
